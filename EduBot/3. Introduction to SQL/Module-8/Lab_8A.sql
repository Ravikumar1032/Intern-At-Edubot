-- Drop the existing 2014 table if it exists
DROP TABLE IF EXISTS pls_fy2014_pupld14a;

-- Create the 2014 Public Libraries Survey table
...
-- Create indexes for the 2014 table
CREATE INDEX libname2014_idx ON pls_fy2014_pupld14a (libname);
CREATE INDEX stabr2014_idx ON pls_fy2014_pupld14a (stabr);
CREATE INDEX city2014_idx ON pls_fy2014_pupld14a (city);
CREATE INDEX visits2014_idx ON pls_fy2014_pupld14a (visits);

-- Populate the 2014 table with data
COPY pls_fy2014_pupld14a
FROM 'C:\Program Files\PostgreSQL\16\sql_files\Lab_8\pls_fy2014_pupld14a.csv'
